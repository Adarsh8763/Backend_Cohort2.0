  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex">
      ...
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden bg-[#0a0a0a]">
        ...
        {/* Golden ambient glow to tie into the theme */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(212,160,23,0.08)_0%,transparent_70%)] mix-blend-overlay" />

        {/* Dark gradient overlay — fades bottom to near-black for seamless blend */}
        <div
          className="absolute inset-0"
          style={{
            background:
              "linear-gradient(to bottom, rgba(10,10,10,0.4) 0%, rgba(10,10,10,0.1) 30%, rgba(10,10,10,0.7) 75%, rgba(10,10,10,1) 100%)",
          }}
        />

        {/* Right-edge gradient to blend into form panel */}
        <div
          className="absolute inset-y-0 right-0 w-48"
          style={{
            background:
              "linear-gradient(to right, rgba(10,10,10,0) 0%, rgba(10,10,10,0.7) 50%, rgba(10,10,10,1) 100%)",
          }}
        />

        {/* SNITCH wordmark — top-left */}
        <div className="absolute top-8 left-8 z-10 select-none">
          <p
            className="text-[#d4a017] text-xl font-bold uppercase"
        ...
        <div className="absolute bottom-10 left-8 z-10 select-none">
          <p
